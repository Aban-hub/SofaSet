...
///
/// To show the [CustomCheckboxListTile] as disabled, pass null as the [onChanged]
/// callback.
///
/// {@tool dartpad --template=stateful_widget_scaffold_center}
///
/// ![CustomCheckboxListTile sample](https://flutter.github.io/assets-for-api-docs/assets/material/checkbox_list_tile.png)
///
...
/// {@end-tool}
///
/// ## Semantics in CustomCheckboxListTile
///
/// Since the entirety of the CustomCheckboxListTile is interactive, it should represent
/// itself as a single interactive entity.
///
/// To do so, a CustomCheckboxListTile widget wraps its children with a [MergeSemantics]
/// widget. [MergeSemantics] will attempt to merge its descendant [Semantics]
/// nodes into one node in the semantics tree. Therefore, CustomCheckboxListTile will
/// throw an error if any of its children requires its own [Semantics] node.
///
/// For example, you cannot nest a [RichText] widget as a descendant of
/// CustomCheckboxListTile. [RichText] has an embedded gesture recognizer that
/// requires its own [Semantics] node, which directly conflicts with
/// CustomCheckboxListTile's desire to merge all its descendants' semantic nodes
...
/// {@end-tool}
///
/// ## CustomCheckboxListTile isn't exactly what I want
///
/// If the way CustomCheckboxListTile pads and positions its elements isn't quite
